...
'''
# --------------------------------------------
# training code for RVRT
# --------------------------------------------
'''

def parse_args():
    default_json_path = 'options/rvrt/001_train_rvrt_videosr_bi_reds_30frames_custom.json'
...
def main():
    ...
    if train_loader is None:
        raise RuntimeError("train_loader가 설정되지 않았습니다.")
    if test_loader is None:
        raise RuntimeError("test_loader가 설정되지 않았습니다.")
